...
const dbConfig = {
  connectionLimit: process.env.ORGA_DB_CONNECTION_LIMIT,
  ...
  database: process.env.ORGA_DB_NAME,
  debug: process.env.ORGA_DB_DEBUG === 'true' ? ['ComQueryPacket', 'RowDataPacket'] : false,
